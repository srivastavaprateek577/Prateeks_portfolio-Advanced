...
import { FaJava, FaAws, FaDocker, FaLinux, FaGitAlt } from 'react-icons/fa';
...
const skills = [
    ...
    { name: "Hibernate", icon: <SiHibernate className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "MySQL", icon: <SiMysql className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 sm:row-span-2 row-span-1" },
    { name: "Redis", icon: <SiRedis className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "AWS", icon: <FaAws className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Docker", icon: <FaDocker className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    ...
    { name: "Git", icon: <FaGitAlt className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Postman", icon: <SiPostman className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "IntelliJ", icon: <SiIntellijidea className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Swagger", icon: <SiSwagger className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
];
